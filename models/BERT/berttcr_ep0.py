...
def compute_metrics(pred):
    ...
    plt.savefig('/tudelft.net/staff-umbrella/tcr/og/roc.png', bbox_inches = 'tight')
    experiment.log_image('/tudelft.net/staff-umbrella/tcr/og/roc.png', name='roc', overwrite=False, image_format="png",
    ...
    plt.legend(bbox_to_anchor=(1.04,1), loc="upper left")
    plt.savefig('/tudelft.net/staff-umbrella/tcr/og/prc.png', bbox_inches = 'tight')
    experiment.log_image('/tudelft.net/staff-umbrella/tcr/og/prc.png', name='prc', overwrite=False, image_format="png",
                    image_scale=1.0, image_shape=None, image_colormap=None,
                    image_minmax=None, image_channels="last", copy_to_tmp=True, step=e)
    plt.close()
...
training_args = TrainingArguments(  
    output_dir='/tudelft.net/staff-umbrella/tcr/og/results',
    logging_dir='/tudelft.net/staff-umbrella/tcr/og/logs',
    num_train_epochs=50,
...
try:
    shutil.rmtree('/tudelft.net/staff-umbrella/tcr/og/results')
    shutil.rmtree('/tudelft.net/staff-umbrella/tcr/og/logs')
...
# study_name = "bert-tuner-0-SO"  # Unique identifier of the study.
# storage_name = "sqlite:///{}.db".format(study_name)
# study = optuna.create_study(study_name=study_name, storage=storage_name, directions=["maximize"] , load_if_exists=True)
# study.enqueue_trial(
#     {
#         "seed": 39,
#         "learning_rate" : 4.263965748413407e-05,
#         "gradient_acm": 64,
#         "hidden_dropout_prob": 0.0,
#         "classifier_dropout": 0.1,
#         "attention_probs_dropout_prob":0.2,
#         "weight_decay" : 1e-05,
#         "adam_beta1": 0.8200000000000001,
#         "adam_beta2": 0.755,
#         "gamma": 5,
#         "warmup_ratio": 0.20
#     }
