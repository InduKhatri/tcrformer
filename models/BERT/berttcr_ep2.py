...
def compute_metrics(pred):
    ...
    plt.savefig('/tudelft.net/staff-umbrella/tcr/md2/roc.png', bbox_inches = 'tight')
    experiment.log_image('/tudelft.net/staff-umbrella/tcr/md2/roc.png', name='roc', overwrite=False, image_format="png",
    ...
    plt.legend(bbox_to_anchor=(1.04,1), loc="upper left")
    plt.savefig('/tudelft.net/staff-umbrella/tcr/md2/prc.png', bbox_inches = 'tight')
    experiment.log_image('/tudelft.net/staff-umbrella/tcr/md2/prc.png', name='prc', overwrite=False, image_format="png",
                    image_scale=1.0, image_shape=None, image_colormap=None,
                    image_minmax=None, image_channels="last", copy_to_tmp=True, step=e)
    plt.close()
...
experiment = comet_ml.Experiment(    
    api_key="",
    project_name="bert-tuner-2-SO",
    workspace=""
    )
hyper_parameters = {
    "seed":29,
    "learning_rate" : 2.4705276082047077e-05,
    "gradient_acm": 61,
    ...
    "weight_decay" : 0,
    "warmup_ratio" : 0.2,
    "adam_beta1": 0.5700000000000001,
    "adam_beta2": 0.7889999999999999,
    "gamma": 5.5
    }
...
training_args = TrainingArguments(  
    output_dir='/tudelft.net/staff-umbrella/tcr/md2/results',
    logging_dir='/tudelft.net/staff-umbrella/tcr/md2/logs',
    num_train_epochs=50,
...
try:
    shutil.rmtree('/tudelft.net/staff-umbrella/tcr/md2/results')
    shutil.rmtree('/tudelft.net/staff-umbrella/tcr/md2/logs')
...
# study_name = "bert-tuner-2-SO"  # Unique identifier of the study.
