...
def compute_metrics(pred):
    ...
    plt.savefig('/tudelft.net/staff-umbrella/tcr/md2_ele/roc.png', bbox_inches = 'tight')
    experiment.log_image('/tudelft.net/staff-umbrella/tcr/md2_ele/roc.png', name='roc', overwrite=False, image_format="png",
    ...
    plt.legend(bbox_to_anchor=(1.04,1), loc="upper left")
    plt.savefig('/tudelft.net/staff-umbrella/tcr/md2_ele/prc.png', bbox_inches = 'tight')
    experiment.log_image('/tudelft.net/staff-umbrella/tcr/md2_ele/prc.png', name='prc', overwrite=False, image_format="png",
                    image_scale=1.0, image_shape=None, image_colormap=None,
                    image_minmax=None, image_channels="last", copy_to_tmp=True, step=e)
    plt.close()
...
experiment = comet_ml.Experiment(    
    api_key="",
    project_name="electra-tuner-2-SO",
    workspace=""
    )
hyper_parameters = {
    "seed": 41,
    "learning_rate" : 3.9411836876278114e-05,
    "gradient_acm": 97,
...
training_args = TrainingArguments(  
    output_dir='/tudelft.net/staff-umbrella/tcr/md2_ele/results',
    logging_dir='/tudelft.net/staff-umbrella/tcr/md2_ele/logs',
    num_train_epochs=50,
...
try:
    shutil.rmtree('/tudelft.net/staff-umbrella/tcr/md2_ele/results')
    shutil.rmtree('/tudelft.net/staff-umbrella/tcr/md2_ele/logs')
...
# study_name = "electra-tuner-2-SO"  # Unique identifier of the study.
