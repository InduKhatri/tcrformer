...
model_name = 'models/ELECTRA/prot_electra_discriminator_bfd'
model_path = 'models/ELECTRA/md_ele/model'
# path where to save results
path = 'tcrformers/predict/ELECTRA/'
...
def compute_metrics(test_results):
    ...
    experiment.log_confusion_matrix(matrix=conf, file_name="confusion-matrix-1.json")
    ...
    plt.savefig(path + 'roc_1.png', bbox_inches='tight')
    experiment.log_image(path + 'roc_1.png', name='roc', overwrite=False,
                         image_format="png",
    ...
    plt.legend(bbox_to_anchor=(1.04, 1), loc="upper left")
    plt.savefig(path + 'prc_1.png', bbox_inches='tight')
    experiment.log_image(path + 'prc_1.png', name='prc', overwrite=False,
                         image_format="png",
                         image_scale=1.0, image_shape=None, image_colormap=None,
                         image_minmax=None, image_channels="last", copy_to_tmp=True, step=1)
    plt.close()
...
model = ElectraForTCRClassification.from_pretrained(model_path)
